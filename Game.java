...
public class Game {
	...
	/*
	 * Initializes a game object using 2 classes
	 * team 1 is always at home
	 * input is provided in a way to make sure that every team plays home and away
	 */
	...
	/*
	 * the two teams first select their starters for the game
	 * the game is played and the victor is determined
	 * all players currently injured are healed since all players heal after one game
	 * then players are randomly injured 
	 * the revenues are updated and the profits are calculated and printed
	 * the victor of the game is returned to the calling object
	 */
	...
	/*
	 * The revenues of each team are updated according to home team and victor team
	 */
	...
	/*
	 * Determining the victor based on the desired criteria
	 * Ties are settled randomly
	 * The victor is returned
	 */
	public Team play() {
	...
	/*
	 * All players who are currently injured will be healed
	 * This is because the current requirement is that every player is healed after being
