...
public class Team {
	...
	/*
	 * Constructor to initialize a Team with NAME, HOMETOWN and GM
	 * population is determined and initialized in the constructor
	 */
	...
	/*
	 * This method selects the starters from the roster
	 * It updates the starters list
	 * 11 players are defensive
	 * 11 players are offensive
	 */
	...
	/*
	 * When a player object is initialized he/she is assigned offensive type or defensive type
	 * This method divides the teams roster into an offensive players' roster and 
	 * a defensive players' roster
	 */
	...
	/*
	 * During off season the age of every player is incremented by 1 year
	 * If a player becomes 31 then he must retire
	 * Is removed from all pools and teams
	...
	/*
	 * Removes all the players who have suffered career ending injuries for whatever reason
	 * For the player to be removed the careerEndingInjury field for the player must be true
	 * The player is removed form all pools
	 * 
